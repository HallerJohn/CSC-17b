...
if(isset($_SESSION['account_id'])){
    ...
    $q1 = "INSERT INTO haller_shop_xref_account_orders (account_id) VALUES ($cid)";
    mysqli_query($conn,$q1);

    // Add the order to the orders table
    $q = "INSERT INTO haller_shop_entity_orders (total, order_date) VALUES ($total,NOW())";
    ...
    if (mysqli_affected_rows($conn) == 1) {
        ...
        $q = "INSERT INTO haller_shop_entity_order_contents (item_id, quantity, price) VALUES (?, ?, ?)";
        ...
        $q2 = "INSERT INTO haller_shop_xref_orders_contents (order_id) VALUES ($oid)";
